    ...
    <div class="card">
        ...
        <form>
                ...
                <div class="p-col-12">
                    ...
                    <div class="p-grid p-formgrid p-mb-3">
                        <div class="p-col-12 p-mb-2 p-lg-5 p-mb-lg-0 p-field">
                            ...
                            <InputText type="text" :class="`${error.title ? 'p-invalid' : ''}`" v-model="title" placeholder="상품명"  id="title2" maxlength="100"></InputText>
                    ...
                    <div class="p-grid p-formgrid p-mb-3">
                        <div class="p-col-12 p-mb-2 p-lg-5 p-mb-lg-0 p-field">
                            ...
                            <Textarea type="text" :class="`${error.description ? 'p-invalid' : ''}`" v-model="description" placeholder="설명"  id="title2" maxlength="200"></Textarea>
                    ...
                    <div class="p-grid p-formgrid p-mb-3">
                        <div class="p-col-12 p-mb-2 p-lg-5 p-mb-lg-0 p-field">
                            <label for="subtitle2">
                                상품 이미지
                                <span class="img-info">(파일 형식: jpg,jpeg,png )(이미지 너비 860px and 고저 924px 및 크기 1MB )</span>
                            </label>
                        ...
                        <div class="raw-image" style="float:right;">
                            ...
                            <img :src=" product_image" alt="이미지를 사용할 수 없음" class="product-image" />
                        </div>
                    ...
                    <div class="p-grid p-formgrid p-mb-3">
                        <div class="p-col-12 p-mb-2 p-lg-5 p-mb-lg-0 p-field">
                            ...
                            <InputText type="text" :class="`${error.honey ? 'p-invalid' : ''}`"   v-model="honey"  placeholder="상품 금액(꿀)"  id="title2" onkeypress="return /[0-9]/i.test(event.key)"></InputText>
            ...
            <div class="p-d-flex p-jc-end p-ai-center" style="float: left;">
                <Button label="저장" iconPos="left" class="p-button p-button-sm p-mr-2 p-mb-2" @click="editProductmanagement" ></Button>
...
import validateCreateProductedit from '../../validations/product/validateCreateProductedit';
    ...
    methods: {
        ...
        editProductmanagement() {
            ...
            let vcheckData = {
                ...
                honey: self.honey.toString(),
                status: self.status ? 'active' : 'inactive',
                file: self.fileName == '' ? '' : 'something',
            };
            //    this.formData.delete('notification_title');
            //     this.formData.delete('description');
            //     this.formData.delete('notification_type');
            //     this.formData.delete('user_ids_arr');
            const { isInvalid, error } = validateCreateProductedit(vcheckData);
            if (isInvalid) {
                self.error = error;
                console.log(error);
            } else {
                ...
                self.formData.append('description', self.description);
                self.formData.append('honey', self.honey);
                self.formData.append('status', self.status == 'active' ? 'active' : 'inactive');
                // console.log(self.name);
                return axios.post('/admin/products/edit', self.formData ).then(() => {
                    // alert('아파트가 성공적으로 추가되었습니다.');
                    self.$router.push({ name: 'ProductManagementList' });
                    setTimeout(() => {
                        self.$toast.add({ severity: 'info', summary: '확인.', detail: '제품이 성공적으로 업데이트되었습니다.', life: 3000 });
                    }, 1000);
                })
                .catch(function (err) {
