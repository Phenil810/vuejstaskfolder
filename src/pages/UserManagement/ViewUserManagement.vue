        ...
        <div class="p-col-12">
            <div class="card p-fluid">
                ...
                <div class="p-field p-grid">
                    <label for="category_name_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Nickname:</label>
                ...
                <div class="p-field p-grid">
                    <label for="material_name_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Apartment Complex:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ apartment_name }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="material_name_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Address:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ address }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="standard_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Email:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ email }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="standard_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Phone:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ mobile }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="material_description_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Year of Birth:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ dob_year }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="material_description_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Gender:</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ $t(gender) }}</p>
                    </div>
                </div>
                ...
                <div class="p-field p-grid">
                    <label for="material_function_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">subscription Method:</label>
                    <div class="p-col-12 p-md-10">
                ...
                <div class="p-field p-grid">
                    <label for="material_function_en" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Type of Family :</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ persons_in_family }}</p>
                    </div>
                </div>

                <div class="p-field p-grid">
                    <label for="daily_intake_amount_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">Children :</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ $t(have_children) }}</p>
