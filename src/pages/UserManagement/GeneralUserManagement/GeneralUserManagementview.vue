    ...
    <div class="p-grid">
        <div class="p-col-12">
            <div class="card p-fluid">
                ...
                <!-- <div class="p-field p-grid">
                    <label for="daily_intake_amount_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">추천 코드:</label>
                    <div class="p-col-12 p-md-10">
                        <span v-if="referral_code == null"> - </span>
                        <span v-else>
                            {{ referral_code }}
                        </span>
                    </div>
                ...
                <div class="p-field p-grid">
                    <label for="daily_intake_amount_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">VIP 사용자:</label>
                    <div class="p-col-12 p-md-10">
                        <span v-if="vip_user == 0"> No</span>
                ...
                <div class="p-field p-grid">
                    <label for="daily_intake_amount_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">VIP 시작 일자 :</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ formatVIPDate(vip_user_start_date) }}</p>
                    </div>
                </div>

                <div class="p-field p-grid">
                    <label for="daily_intake_amount_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">VIP 종료 일자 :</label>
                    <div class="p-col-12 p-md-10">
                        <p>{{ formatVIPDate(vip_user_end_date) }}</p>
                    </div>
                </div>
                <div class="p-d-flex p-jc-end" style="float: left">
                    <router-link :to="'/UserManagement/GeneralUserManagement/GeneralUserManagementEdit/' + $route.params.id">
...
export default {
    ...
    mounted() {
        ...
        this.usermanagementService.userview(this.$route.params.id).then((res) => {
            ...
            this.vip_user_start_date = res.data.result.vip_user_start_date;
            this.vip_user_end_date = res.data.result.vip_user_end_date;
