            ...
            <div class="card p-fluid">
                ...
                <div class="p-formgrid p-grid p-mb-3">
                    <div class="p-field p-col-12 p-md-3">
                        ...
                        <InputText id="nameuser" type="text" v-model="name" placeholder="선택" />
                ...
                <div class="p-d-flex p-jc-between p-ai-lg-center p-ai-start p-mt-6 p-flex-column p-flex-lg-row">
                    ...
                    <div>
                        <Button label="검색" icon="pi pi-search" iconPos="left" class="p-button p-button-sm p-mr-2 p-mb-2" @click="searchtag"></Button>
            ...
            <div class="card">
                <div class="p-d-flex p-jc-between p-mb-2">
                    ...
                    <div>
                        ...
                        <router-link to="/GeneralManagement/TagManagement/TagManagementadd">
                ...
                >
                    ...
                    <!-- <column selectionMode="multiple" style="width: 16px; text-align: center" /> -->                    
                        <Column rowReorder headerStyle="width: 3rem" :reorderableColumn="false" style="cursor: pointer" />
                    ...
                    <Column header="텍스트 색상" style="min-width: 12rem">
                        <template #body="{ data }">
                            <span class="p-column-title">Tag</span>
                            <span v-if="data.color == '#458AED'">
                                <p style="color: #458aed">라이트블루</p>
                            </span>
                            <span v-else-if="data.color == '#FF9067'">
                                <p style="color: #ff9067">주황색</p>
                            </span>
                            <span v-else-if="data.color == '#93C04F'">
                                <p style="color: #93c04f">녹색</p>
                            </span>
                            <span v-else-if="data.color == '#FF6744'">
                                <p style="color: #ff6744">다크오렌지</p>
                            </span>
                            <span v-else-if="data.color == '#FBBA7C'">
                                <p style="color: #fbba7c">라이트오렌지</p>
                            </span>
                            <span v-else-if="data.color == '#FDAA2E'">
                                <p style="color: #fdaa2e">노란색</p>
                            </span>
                            <span v-else-if="data.color == '#A8A08D'">
                                <p style="color: #a8a08d">회색</p>
                            </span>
                    ...
                    <Column header="노출" style="min-width: 12rem">
                        <template #body="{ index, data }">
                            ...
                            <span v-if="badge_earned_tags != ''">
                                <span v-if="data.id == badge_earned_tags">
                                    <InputSwitch :modelValue="getStatus(data.status)" disabled />
                                </span>
                                <span v-else>
                    ...
                    <Column header="등록일자" style="min-width: 12rem">
                        <template #body="{ data }">
                            <span class="p-column-title">Tag Creation Date</span>
                    ...
                    <Column header="기능">
                        <template #body="{ data }">
                            ...
                            <div style="display: flex">
                                <span v-if="data.fixed_tags == 0">
                                    <router-link :to="'/GeneralManagement/TagManagement/TagManagementEdit/' + data.id"
                                        ><Button label="info" class="p-button2"><i class="pi pi-user-edit p-mr-2"></i> </Button>
                                    </router-link>
                                </span>
                                <span v-else-if="data.fixed_tags == 1">
                                    <Button label="info" class="p-button2" disabled><i class="pi pi-user-edit p-mr-2"></i> </Button>
                                </span>

                                <router-link :to="'/GeneralManagement/TagManagement/TagManagementView/' + data.id"
                                ...
                                <span v-else-if="data.fixed_tags == 1">
                                    <Button icon="pi pi-trash" class="p-button2" @click="deleteNote(data.id)" disabled />
                                </span>
                                <!-- <span v-if="badge_earned_tags != ''">
                                    <span v-if="data.id == badge_earned_tags">
                                        <Button icon="pi pi-trash" class="p-button2" @click="deleteNote(data.id)" disabled />
                                    ...
                                    <span v-else>
                                        ...
                                        <span v-else>
                                            <Button icon="pi pi-trash" class="p-button2" @click="Tagdelete" />
                                        </span>
                                    </span>
                                </span> -->
                                <!-- <span v-else>
...
export default {
    ...
    mounted() {
        ...
        this.storageData = localStorage.getItem('TagManagement') ? JSON.parse(localStorage.getItem('TagManagement')) : '';
        console.log(this.storageData, 'data');

        if (this.storageData != '') {
            this.tagManagementlistpagination = this.storageData.page;
            this.title = this.storageData.title;
            this.startDate = this.storageData.startDate;
            this.endDate = this.storageData.endDate;
        }

        if (this.tagManagementlistpagination == '' || this.tagManagementlistpagination == null) {
            if (this.title || this.startDate || this.endDate) {
                ...
                this.tagManagementlist(searchListParams);
            } else {
                const searchListParams = {
                    page: Number(this.pagination.current_page),
                    limit: this.pagination.pagination_limit,
            ...
            const searchLocalParams = {
                page: Number(this.tagManagementlistpagination),
                limit: this.pagination.pagination_limit,
                name: this.name,
                startDate: this.startDate,
                endDate: this.endDate,
            ...
            this.tagManagementlist(searchLocalParams);
        }
    },
    watch: {},
    methods: {
        ...
        onRowReorder(event) {
            ...
            this.tagManagementService
                ...
                .then((res) => {
                    ...
                    if(this.tagManagementlistpagination == '' || this.tagManagementlistpagination == null){
                        this.tagManagementlist({ page: 1, limit: this.pagination.pagination_limit });

                    } else {
                        this.tagManagementlist({ page:  this.tagManagementlistpagination, limit: this.pagination.pagination_limit });
        ...
        Changestatus(index, id) {
            ...
            var tagstatus = { ...{ id: id, status: this.customer1[index].status } };
            // console.log('companystatus', companystatus);
            this.tagManagementService.tagchange_status(tagstatus).then((res) => {
                // console.log(res);
                if (res.status === 200) {
                    this.$toast.add({ severity: 'info', summary: '성공적으로', detail: '태그 상태 수정이 완료되었습니다.', life: 3000 });
                    this.tagManagementlist({ page: 1, limit: this.pagination.pagination_limit });
                }
            });
        },
        Tagdelete() {
            this.$toast.add({ severity: 'info', detail: '이 태그는 이미 사용 중이므로 삭제할 수 없습니다.', life: 3000 });
        },

        tagManagementlist(data) {
            ...
            this.tagManagementService
                ...
                .then((res) => {
                    ...
                    this.badge_earned_tags = res.data.badge_earned_tags;
                    ...
                    console.log('hi', res.data.badge_earned_tags);
        ...
        paginate(page) {
            ...
            this.tagManagementService
                .getTagManagementList({ page: page, limit: this.pagination.pagination_limit, name: this.name, startDate: this.searchdate, endDate: this.searchenddate })
                .then((res) => {
                    this.customer1 = res.data.result;
                    this.totalrecords = res.data.total_records;
        ...
        resettag() {
            localStorage.setItem('TagManagement', '');
            (this.name = ''), (this.startDate = ''), (this.endDate = ''), this.tagManagementlist({ page: 1, limit: this.pagination.pagination_limit });
        },
        searchtag() {
            ...
            if (this.name !== '' || this.startDate !== '' || this.endDate !== '') {
                ...
                this.customer1 = true;
                this.tagManagementService
                    .getTagManagementList(searchParams)
                    .then((res) => {
                        console.log('res', res);
                        this.customer1 = res.data.result;
                        this.totalrecords = res.data.total_records;
        ...
        deleteNote: function (id) {
            ...
            this.$confirm.require({
                ...
                rejectLabel: ' 취소',
                accept: () => {
                    self.tagManagementService
                        .delete({ id: id })
                        .then(function (response) {
                            console.log(response);
                            self.tagManagementlist({ page: self.pagination.current_page, limit: self.pagination.pagination_limit });
