            ...
            <div class="p-grid">
                <div class="p-col-12">
                    ...
                    <DataTable :value="products" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id" :rowHover="true" :loading="loading1" :filters="filters1" responsiveLayout="scroll">
                        ...
                        <Column field="Change Order" :header="$t('nft.list.changeorder')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                        ...
                        <Column field="Image" :header="$t('nft.list.image')" class="n-wrap">
                            <template #body="{ data }">
                                <span class="p-column-title">Image</span>
                                <img :src="img_daUrl + data.imageUrl" :alt="data.imageUrl" class="product-image" />
                            </template>
                        </Column>
                        <Column field="Title" :header="$t('nft.list.title')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                        ...
                        <Column field="Status" :header="$t('nft.list.status')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                                <span class="p-column-title">Status</span>
                                <InputSwitch v-model="data.status" trueValue="active" @change="switchValue(data.id, data.status)" />
                            </template>
                        </Column>
                        <Column field="Date & Time" :header="$t('nft.list.created_dt')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
