                ...
                <div class="p-col-12">
                    ...
                    <div class="p-grid p-formgrid p-mb-3">
                        ...
                        <div class="p-col-12 p-mb-2 p-lg-3 p-mb-lg-0 p-field">
                            ...
                            <Dropdown :class="`${error.state ? 'p-invalid' : ''}`" v-model="dropdownValue" modelValue="dropdownValues[0].name" :options="dropdownValues" optionLabel="code" placeholder="선택" />
...
export default {
    ...
    methods: {
        ...
        onFileChanges(e) {
            this.formData.delete('mobileImage');
            var files = e.target.files || e.dataTransfer.files;
            if (!files.length) return;
            this.files = files[0];
            var allowedExtensions = /(\.jpg|\.jpeg|\.png|\.gif)$/i;
