...
import validateCreateRewardManagement from '../../validations/RewardManagement/validateCreateRewardManagement';
...
export default {
    ...
    methods: {
        ...
        editHoneymanagement() {
            ...
            const { isInvalid, error } = validateCreateRewardManagement(vcheckData);
            if (isInvalid) {
                self.error = error;
                console.log(error);
            } else {
