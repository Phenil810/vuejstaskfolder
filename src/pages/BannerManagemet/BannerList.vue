            ...
            <div class="p-grid">
                <div class="p-col-12">
                    ...
                    <DataTable :value="products" :paginator="true" class="p-datatable-gridlines" :rows="10" data-key="id" :rowHover="true" :loading="loading1" :filters="filters1" responsiveLayout="scroll">
                        ...
                        <template #empty>등록된 정보가 없습니다.</template>
                        <template #loading>로딩 중입니다. 잠시만 기다려주세요. </template>

                        <Column field="Sl. No." header="No." style="min-width: 3rem" class="n-wrap">
                            <template #body="{ index }">
                                <span class="p-column-title">Sl. No.</span>
                                {{ index + 1 }}
                            </template>
                        </Column>
                        <Column field="Change Order"  :header="$t('Banner.list.changeorder')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                        ...
                        <Column field="Image" :header="$t('Banner.list.image')" class="n-wrap">
                            <template #body="{ data }">
                                <span class="p-column-title">Image</span>
                                <img :src="img_daUrl + data.imageUrl" :alt="data.imageUrl" class="product-image"  />
                            </template>
                        </Column>
                        <Column field="Title" :header="$t('Banner.list.title')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                                <span class="p-column-title">Title</span>
                                {{ data.title }}
                            </template>
                        </Column>
                        <Column field="Type" :header="$t('Banner.list.type')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                        ...
                        <Column field="Exposure" :header="$t('Banner.list.status')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                        ...
                        <Column field="Creation-Date" :header="$t('Banner.list.created_dt')" style="min-width: 12rem" class="n-wrap">
                            <template #body="{ data }">
                                <span class="p-column-title">Creation-Date</span>
                                {{ formatDate(data.createdDate) }}
                            </template>
                        </Column>
                        <Column field="Actions" :header="$t('Banner.list.see_more')" class="n-wrap">
                            <template #body="{ data }">
        ...
        confirm(id) {
            this.$confirm.require({
                ...
                accept: () => {
                    ...
                    this.$toast.add({ severity: 'info', summary: '삭제되었', detail: '성공적으로 삭제되었습니다.', life: 3000 });
                },
                reject: () => {
