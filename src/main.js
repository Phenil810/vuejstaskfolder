...
// axios.defaults.baseURL = 'https://api.ggulpot-admin.com/api/v1/';   //live
axios.defaults.baseURL = 'https://gscm-api-dev.dvconsulting.org/api/v1/';  // demo
// axios.defaults.baseURL = 'https://api-uat.ggulpot-admin.com/api/v1/';  // UAT
...
const app = createApp({
    ...
    mounted() {
        ...
        this.$primevue.config.locale.clear = '초기화';
