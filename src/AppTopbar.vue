        ...
        <div class="layout-topbar-wrapper">
            <div class="layout-topbar-left">
                ...
                <router-link id="logo-link" class="layout-topbar-logo" to="/">
                    <img v-show="rend" v-bind:src="logogscommunity" style="height: 25px; width: auto" alt="GS Community" />
                    <!-- <img src="assets/layout/images/wallet2.png" style="height: 25px; margin: -20px 0px 0px -10px" alt="GS Community" /> -->
            ...
            <div class="layout-topbar-right">
                <ul class="layout-topbar-actions">
                    ...
                    <li ref="profile" class="topbar-item user-profile" :class="{ 'active-topmenuitem fadeInDown': topbarUserMenuActive }">
                        ...
                        <a @click="onTopbarUserMenuClick" style="color: black; font-weight: bold; margin-left: 0px; width: 150%">Admin</a>
                        <i class="pi pi-angle-down" @click="onTopbarUserMenuClick"></i>
                        <ul class="fadeInDown">
